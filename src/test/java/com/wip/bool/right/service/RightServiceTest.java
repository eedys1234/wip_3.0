...
public class RightServiceTest {
    ...
    public void 권한_추가_Service() throws Exception {
        ...
        //when
        doReturn(right).when(rightRepository).save(any(Right.class));
        ...
        //verify
        verify(rightRepository, times(1)).save(any(Right.class));
    }
    ...
    public void 권한_삭제_Service() throws Exception {
        ...
        doNothing().when(rightRepository).delete(any(Right.class));
        ...
        verify(rightRepository, times(1)).delete(any(Right.class));
    }
}
